    ...
    return (
        <section className="space-y-8 pt-8">
            ...
            <div id="admin-auth" className="scroll-mt-24 space-y-4">
                ...
                <div className="bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-700 rounded-lg p-4 space-y-2 relative">
                    <button
                        type="button"
                        onClick={() => {
                            setImgError(false);
                    ...
                    <div className="flex items-start gap-2">
                        <Shield className="h-4 w-4 text-slate-500 dark:text-slate-400 mt-0.5" />
                    ...
                    <div className="flex items-start gap-2">
                        <Database className="h-4 w-4 text-slate-500 dark:text-slate-400 mt-0.5" />
                        <div className="text-xs text-slate-600 dark:text-slate-400">
                    ...
                    <div className="flex items-start gap-2">
                        <Lock className="h-4 w-4 text-slate-500 dark:text-slate-400 mt-0.5" />
                        <div className="text-xs text-slate-600 dark:text-slate-400">
            ...
            <div id="admin-force" className="scroll-mt-24 space-y-4">
                ...
                <Card className="bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800 p-5">
                    <div className="flex items-start gap-4">
                        <div className="p-2 bg-white dark:bg-slate-800 rounded-full text-red-600 dark:text-red-400 shadow-sm mt-1">
                            <Trash2 className="h-5 w-5" />
                        </div>
                        <div>
                            <h4 className="font-bold text-red-900 dark:text-red-300 mb-1">あらゆる楽曲を削除可能</h4>
                            <p className="text-sm text-red-800 dark:text-red-300 leading-relaxed mb-3">
                                管理者は、ユーザーが誰であるか、ログイン状態に関わらず、リスト内の楽曲を強制的に削除できます。
                            </p>
                            <ul className="text-xs text-red-800 dark:text-red-300 list-disc pl-4 space-y-1 bg-white/50 dark:bg-slate-800/50 p-3 rounded">
                                <li>不適切な動画の排除</li>
                                <li>再生トラブル時の強制スキップ</li>
                                <li>ゲストユーザーが間違えて追加した曲の削除代行</li>
                            </ul>
                            <div className="mt-3 p-3 bg-white/70 dark:bg-slate-800/70 rounded border border-red-200 dark:border-red-800">
